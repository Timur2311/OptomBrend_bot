...
from telegram.ext import (
    ...
    CommandHandler, MessageHandler, ChatMemberHandler,
...
from tgbot.handlers.onboarding.handlers import conv_handler
...
def setup_dispatcher(dp):
    ...
    dp.add_handler( MessageHandler(Filters.chat(-1001572519768), handlers.typing)),
    ...
    # dp.add_handler(MessageHandler(Filters.all, onboarding_handlers.file))
